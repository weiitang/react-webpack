...
export declare class Range extends Type {
  constructor(options: { min: number; max: number; minBound?: boolean; maxBound?: boolean });
}

export declare function range(options: { min: number; max: number; minBound?: boolean; maxBound?: boolean }): Range;
...
export declare class Rule {
  ...
  constructor(options: { name: string; pattern: any; message: string });
...
type IBindFn = (store: Store, on: string) => IBindFn;
...
export declare class Store {
  ...
  observe(
    target: Store | Model | Function,
    subscribe: (target: Store | Model) => (dispatch: IWatchFn) => Function | void,
    unsubcribe: (target: Store | Model) => (dispatch: IWatchFn) => void,
  ): Function;
  ...
  dispatch(
    keyPath: string | (string | symbol)[],
    info: { value: any; next: any; prev: any; active: any; invalid: any; compute: boolean },
    force?: boolean,
  ): boolean;
...
export declare class Validator<T extends Model = Model, I extends any = any> {
  ...
  static readonly match: <T extends Model>(
    validator: RegExp | string | number | boolean | ((this: T, value: any) => boolean) | any,
    message: string,
    name?: string,
  ) => Validator;
...
type MetaClass<T = any, I = T, M extends Model = Model, U extends Obj = Obj> = new (options: Attrs<T, I, M, U>) => Meta<
  T,
  I,
  M,
  U
...
export type Attrs<T = any, I = T, M extends Model = Model, U extends Obj = Obj> = {
   ...
   */
  validators?:
    | (Validator<M, I> | ValidatorOptions<M, I>)[]
    | {
...
export declare class Meta<T = any, I = T, M extends Model = Model, U extends Obj = Obj> {
  ...
  extend<D extends T = T, V extends I = I, O extends M = M, B extends Obj = U>(
    attrs: Partial<Attrs<D, V, O, B>>,
  ): Meta<D, V, O, B>;
  static extend<T = any, I = T, M extends Model = Model, U extends Obj = Obj>(
    attrs: Attrs<T, I, M, U>,
  ): typeof Meta & MetaClass<T, I, M, U>;
  static create<T = any, I = T, M extends Model = Model, U extends Obj = Obj>(
    attrs: Attrs<T, I, M, U>,
  ): typeof Meta & MetaClass<T, I, M, U>;
}
...
export declare class SceneMeta<T = any, I = T, M extends Model = Model, U extends Obj = Obj> extends Meta<T, I, M, U> {
  ...
  defineScenes(): {
    [sceneCode: string]:
      | Partial<Attrs<T, I, M, U>>
      | (() => Partial<Attrs<T, I, M, U>>)
      | (() => Promise<Partial<Attrs<T, I, M, U>>>);
  };
  /**
...
export declare class StateMeta<T = any, I = T, M extends Model = Model, U extends Obj = Obj> extends Meta<T, I, M, U> {
  constructor(
    attrs?: Omit<Attrs<T, I, M, U>, 'default' | 'validators' | 'drop' | 'to' | 'map' | 'disabled' | 'state'> & {
      value: T;
    },
  );
}

export declare class SceneStateMeta<T = any, I = T, M extends Model = Model, U extends Obj = Obj> extends SceneMeta<
  T,
  I,
  M,
  U
 ...
 * @param attrs
 */
export declare function createMeta<T = any, I = T, M extends Model = Model, U extends Obj = Obj>(
  attrs: Attrs<T, I, M, U>,
): Meta<T, I, M, U>;
 ...
 * @param asyncGetter
 */
export declare function createAsyncMeta<T = any, I = T, M extends Model = Model, U extends Obj = Obj>(
  attrs: Attrs<T, I, M, U>,
  asyncGetter: () => Promise<Partial<Attrs<T, I, M, U>>>,
): AsyncMeta<T, I, M, U>;
 ...
 * @param mapping
 */
export declare function createSceneMeta<T = any, I = T, M extends Model = Model, U extends Obj = Obj>(
  attrs: Attrs<T, I, M, U>,
  mapping: SceneMapping<T, I, M, U> | (() => SceneMapping<T, I, M, U>),
): SceneMeta<T, I, M, U>;
 ...
 * @param attrs
 */
export declare function createStateMeta<T = any, I = T, M extends Model = Model, U extends Obj = Obj>(
  attrs: Omit<Attrs<T, I, M, U>, 'default' | 'drop' | 'to' | 'map' | 'state'> & { value: T },
): Meta<T, I, M, U>;
 ...
 * @param mapping
 */
export declare function createSceneStateMeta<T = any, I = T, M extends Model = Model, U extends Obj = Obj>(
  attrs: Omit<Attrs<T, I, M, U>, 'default' | 'drop' | 'to' | 'map' | 'state'> & { value: T },
  mapping: SceneMapping<T, I, M, U> | (() => SceneMapping<T, I, M, U>),
): SceneMeta<T, I, M, U>;
 ...
 */
export declare type ReflectMeta<A extends Meta | MetaClass, key = 'value'> = A extends SceneStateMeta<
  infer T,
  infer I,
  infer M,
  infer U
 ...
 */
export declare type ReflectView<M extends Meta | MetaClass> = M extends SceneMeta<infer T, infer I>
  ? View<T, I>
  : M extends SceneMeta<infer T, infer I>
  ? View<T, I>
  : M extends AsyncMeta<infer T, infer I>
  ? View<T, I>
  : M extends Meta<infer T, infer I>
  ? View<T, I>
  : M extends MetaClass<infer T, infer I>
  ? View<T, I>
  : View;
...
export declare class Model implements Obj {
   ...
   * @param chunk
   */
  Chunk<U extends any[] = any[]>(
    chunk?: FactoryChunk<Model, any, U>,
  ): {
  ...
  use<T = any, I = T, M extends Model = Model, U extends Obj = Obj, N extends Meta = Meta<T, I, M, U>>(
    meta: N,
  ): ReflectView<N>;
  use<T = any, I = T, M extends Model = Model, U extends Obj = Obj, R = any, N extends Meta = Meta<T, I, M, U>>(
    meta: N,
    getter: (view: ReflectView<N>) => R,
  ): R;
...
export declare class Factory {
  ...
  static createMeta<
    ...
    U extends Obj = Obj,
    T extends ModelClass = ConstructorOf<I>,
  >(
    entries: T,
    attrs?: Omit<Attrs<InstanceType<T>, InstanceType<T>, M, U>, 'default'>,
    hooks?: FactoryHooks,
  ): Meta<InstanceType<T>, InstanceType<T>, M, U>;
  ...
  static createMeta<
    ...
    M extends Model = Model,
    U extends Obj = Obj,
    T extends ModelClass[] = ConstructorOf<ItemOf<I>>[],
  >(
    entries: T,
    attrs?: Omit<Attrs<InstanceType<ItemOf<T>>[], InstanceType<ItemOf<T>>[], M, U>, 'default'>,
    hooks?: FactoryHooks,
  ...
  >(
    entries: T[],
    select: (entries?: T[], data?: any, parent?: Model) => T,
    attrs?: Omit<Attrs<InstanceType<T>, InstanceType<T>, M, U>, 'default'>,
    hooks?: FactoryHooks,
  ): Meta<InstanceType<T>, InstanceType<T>, M, U>;
...
declare function meta<T = any, I = T, M extends Model = Model, U extends Obj = Obj>(
  entries: Attrs<T, I, M, U> | Meta<T, I, M, U> | MetaClass<T, I, M, U>,
): PropertyDecorator;
declare function meta<T = any, I = T, M extends Model = Model, U extends Obj = Obj>(
  entries: ModelClass | ModelClass[],
  attrs?: Attrs<T, I, M, U>,
  hooks?: FactoryHooks,
): PropertyDecorator;
export { meta };
...
export declare function state<T>(
  options: { value: T } | { get: () => T; set?: (v: T) => void } | Meta,
): PropertyDecorator;
